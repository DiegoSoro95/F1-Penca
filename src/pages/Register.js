...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Error al crear la cuenta: ' + (error.response?.data?.message || error.message));
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className={`col-md-8 col-lg-6 ${animate ? 'slide-in-left' : ''}`}>
              <div className="register-card">
                <div className="text-center mb-4">
                  ...
                  <h2 className="h3 mb-3 text-warning">ÚNETE A LA COMPETICIÓN</h2>
